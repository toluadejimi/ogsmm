                            ...
                            <div class="card-body">
                                <div class="">
                                    ...
                                    <form action="{{ route('user.fundMoney') }}" method="POST">
                                        ...
                                        <input type="text" name="amount" class="form-control" max="999999"
                                            min="5" name="amount" placeholder="Enter the Amount you want Add"
                                            required>
...
{{--                                            <option value="2">Manual</option>--}}
    ...
    <div id="signup-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel"
